...
#ifdef CONFIG_LGE_PM
		smblib_write(chg, USBIN_CURRENT_LIMIT_CFG_REG, 0x09); //set icl 450mA for pm7250b issue
#endif
		break;
	case USBIN_900MA:
		/* USB 3.0 900mA */
...
#ifdef CONFIG_LGE_PM
		smblib_write(chg, USBIN_CURRENT_LIMIT_CFG_REG, 0x11); //set icl 8500mA for pm7250b issue
#endif
		break;
	default:
		return -EINVAL;
